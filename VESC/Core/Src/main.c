...
int main(void)
{
  ...
  while (1)
  {
    can_send_command(&vesc, CAN_PACKET_SET_DUTY,0.5,1);
	  can_send_command(&vesc, CAN_PACKET_SET_CURRENT,1000,1);
    can_send_command(&vesc, CAN_PACKET_SET_RPM,1000,1);

    // comm_can_set_rpm(101,1000);
    // vesc_can_set_duty(101,0.5);
